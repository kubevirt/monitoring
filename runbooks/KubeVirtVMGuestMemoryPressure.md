...
## Meaning
The virtual machine (VM) guest operating system (OS) is under sustained memory pressure
(low usable memory with elevated major page faults and/or swap I/O). This can cause
